...
$stmtReservas = $pdo->prepare("SELECT reservas.id_reserva, clientes.nome AS nome_cliente, reservas.data_reserva, reservas.horario_inicio, reservas.horario_fim 
                               ...
                               WHERE reservas.id_estabelecimento = :id_estabelecimento AND reservas.status = 'confirmada'");
...
<main>
	<section class="dashboard">
		<h2>Reservas Ativas de: <span class="nome-estabelecimento"><?php echo htmlspecialchars($nome_estabelecimento); ?></span></h2>
				...
				<?php foreach ($reservas as $reserva) : ?>
					<tr>
						...
						<td>
							...
							<form action="config/processar_reserva_ativa.php" method="POST" style="display:inline;">
